...
public:
  sVol() {};
  sVol(double spot, double var0, double kappa, double theta, double xi,
       double rho, int seed);
  ~sVol() {};
  ...
  std::vector<double> simulationHestonMax(std::vector<double> times,
                                          std::vector<double> forwards) const;
  std::vector<double> simulationHestonCliq(std::vector<double> times,
                                           std::vector<double> forwards,
                                           double gcap, double gfloor,
                                           double lcap, double lfloor,
                                           double alpha) const;
  std::vector<double> simulationHestonDNT(std::vector<double> times,
                                          std::vector<double> forwards,
                                          double UP, double DOWN) const;
  double simulationHestonDNTdt(std::vector<double> times,
                               std::vector<double> forwards, double UP,
                               double DOWN, double dt) const;
  int simulationHestonDNTdtS(std::vector<double> times,
                             std::vector<double> forwards, double maturity,
                             double UP, double DOWN, double dt) const;
  int simulationHestonDNTdtE(std::vector<double> times,
                             std::vector<double> forwards, double maturity,
                             double UP, double DOWN, double dt) const;
  std::vector<double> simulationHestonUpnOut(std::vector<double> times,
                                             std::vector<double> forwards,
                                             double BARRIER) const;
  std::vector<double> simulationHestonDownnOut(std::vector<double> times,
                                               std::vector<double> forwards,
                                               double BARRIER) const;
...
private:
  ...
  double hestonIntegrand(std::complex<double> k, double maturity,
  ...
  double hestonIntegrandNET(std::complex<double> k, double maturity,
