...
{
public:
	cms_spread(double expirySR1, double tenorSR1, double forwardSR1, double annuitySR1, 
		double payCMS1, double discountCMS1, 
		double beta1, CellMatrix& strikes1, CellMatrix& marketQuotes1, std::string quoteType1,
		double expirySR2, double tenorSR2, double forwardSR2, double annuitySR2, 
		double payCMS2, double discountCMS2, 
		double beta2, CellMatrix& strikes2, CellMatrix& marketQuotes2, std::string quoteType2,
		double corr);

	// Added function by James Carey on 19-11-2015 to allow for alternative convexity adjustment calculation
	cms_spread(double expirySR1, double tenorSR1, double forwardSR1, double freqSR1, double freqCMS1, 
		double payCMS1, double discountCMS1, 
		double beta1, CellMatrix& strikes1, CellMatrix& marketQuotes1, std::string quoteType1,
